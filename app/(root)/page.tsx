      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            ...
            alt="Brian Duarte - Qa Engineer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-base sm:text-lg font-serif italic tracking-wide">
              Ensuring software quality with precision.
            </p>
          </div>
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                href={"/Brian_Duarte_Suarez_CV_template_English.pdf"}
                target="_blank"
            ...
            <AnimatedText delay={0.9}>
              <Link
                href="https://wa.me/+526251130774"
                target="_blank"
                rel="noreferrer"
                className={cn(buttonVariants({ variant: "outline", size: "lg" }))}
                aria-label="Contact Brian Duarte via WhatsApp"
              >
